<?php include('header.php'); ?>
    ...
    <section class="grid-12 content-area grey">
        <div class="section-container">
            <div class="grid-4">
                ...
                <a class="button full animated fadeInUp" href="/login/register">Register Now</a>
            </div>
            <div class="grid-8">
                <p>
                ...
                <img class="image_1" src="/static/media/JohnAnthonyVella.png"></img>
            </div>
        </div>
    </section>
    ...
    <section class="grid-12 content-area">
        <div class="section-container">
            <div class="grid-8">
                <img class="image_2" src="/static/media/Phone.jpg"></img>
            </div>
            <div class="grid-4">
    ...
    <section class="grid-12 content-area">
        <div class="section-container">
            ...
            <div class="grid-8">
                <img class="image_2" src="/static/media/Chart.jpg"></img>
            </div>
        </div>
    </section>
    ...
    <?php $sites_count = $monitors['COUNT(*)']; ?>
    <section class="grid-12 content-area">
        <div class="col-full">
